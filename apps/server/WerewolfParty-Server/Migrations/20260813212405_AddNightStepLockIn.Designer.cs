...
namespace WerewolfParty_Server.Migrations
{
    ...
    [Migration("20260813212405_AddNightStepLockIn")]
    partial class AddNightStepLockIn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WerewolfParty_Server.Entities.RoomEntity", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("NightStepLockedIn")
                        .IsRequired()
                        .HasColumnType("integer[]")
                        .HasColumnName("night_step_locked_in");
